...
<body class="min-h-screen bg-[#f5f9ff] flex items-center justify-center" x-data="{
    toasts: [],
        ...
        document.addEventListener('DOMContentLoaded', function () {
            @if (session('status') === 'verification-link-sent')
                window.dispatchEvent(new CustomEvent('toast', {
                    detail: { message: 'The verification link has been sent to your email address.', type: 'success' }
                }));
            @endif
        });
    </script>
