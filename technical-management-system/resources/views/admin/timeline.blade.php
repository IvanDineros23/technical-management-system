...
@section('page-title', 'System Timeline')
@section('page-subtitle', 'Complete system-wide activity overview')
    ...
    <div class="bg-white dark:bg-gray-800 rounded-[20px] shadow-md border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex items-center justify-between mb-6">
            <div class="bg-blue-600 text-white px-4 py-2 rounded-lg">
                <h3 class="font-bold">Complete System Timeline</h3>
                <p class="text-sm">All activities across all departments and users</p>
            </div>
        </div>
        ...
        <div class="space-y-4">
            ...
            @empty
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No system activities</h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">System activities will appear here.</p>
                </div>
            @endforelse
        </div>
