...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-[20px] shadow-md border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h3 class="text-lg font-bold text-gray-900 dark:text-white">Complete System Timeline</h3>
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">All activities across all departments and users</p>
            </div>
        </div>
