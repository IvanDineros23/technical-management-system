...
<body class="h-full bg-gray-100 overflow-hidden">
    <div class="flex h-full">
        <!-- Sidebar -->
        <aside class="w-64 flex-shrink-0 bg-gradient-to-b from-blue-100 to-blue-50 rounded-r-3xl shadow-lg flex flex-col overflow-hidden">
            <!-- Logo -->
            <div class="p-5 flex-shrink-0">
                <div class="flex flex-col items-center gap-3">
                    ...
                    <h1 class="text-lg font-bold text-gray-800 text-center">Gemarc - TMS</h1>
                </div>
            </div>
            ...
            <div class="px-4 py-3 flex-shrink-0">
                <div class="flex gap-2">
                    <button class="flex-1 flex items-center justify-center gap-1 px-2 py-2 bg-blue-500 text-white rounded-xl text-xs font-medium">
                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/>
                        </svg>
                        Light
                    </button>
                    <button class="flex-1 flex items-center justify-center gap-1 px-2 py-2 bg-white text-gray-600 rounded-xl text-xs font-medium">
                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- User Info -->
            <div class="px-4 py-3 border-t border-blue-200 flex-shrink-0">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="w-full flex items-center gap-2 px-2 py-1.5 text-xs text-gray-600 rounded-lg hover:bg-blue-100 hover:text-gray-900 transition-colors">
                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
