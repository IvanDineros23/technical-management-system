    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div class="bg-white dark:bg-gray-800 rounded-[20px] shadow-md border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Today Tasks</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ $stats['today_tasks'] ?? 0 }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-[20px] shadow-md border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-600 dark:text-green-400 mt-1">{{ $stats['completed_today'] ?? 0 }}</p>
                </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-[20px] shadow-md border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex items-center justify-between mb-6">
            <div class="bg-blue-600 text-white px-4 py-2 rounded-lg">
                <h3 class="font-bold">Technician Work Timeline</h3>
                <p class="text-sm">Your assignments and work progress</p>
            </div>
        </div>
        ...
        <div class="space-y-4">
            ...
            @empty
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No work tasks</h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Your work assignments will appear here.</p>
                </div>
            @endforelse
        </div>
