...
@section('content')
    ...
    <div class="space-y-4 sm:space-y-6">
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4">
            <div class="bg-white dark:bg-gray-800 rounded-[20px] shadow-md border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
                <div class="flex items-start sm:items-center justify-between gap-3">
                    <div>
                        <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 break-words">New Requests</p>
                        <p class="text-xl sm:text-2xl font-bold text-amber-600 dark:text-amber-400 mt-1">{{ $stats['new_requests'] ?? 0 }}</p>
                    </div>
                    <div class="w-10 h-10 sm:w-12 sm:h-12 bg-amber-100 dark:bg-amber-900/30 rounded-xl flex items-center justify-center flex-shrink-0">
                        <svg class="block w-5 h-5 sm:w-6 sm:h-6 text-amber-600 dark:text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-[20px] shadow-md border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
                <div class="flex items-start sm:items-center justify-between gap-3">
                    <div>
                        <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 break-words">Approved</p>
                        <p class="text-xl sm:text-2xl font-bold text-emerald-600 dark:text-emerald-400 mt-1">{{ $stats['approved'] ?? 0 }}</p>
                    </div>
                    <div class="w-10 h-10 sm:w-12 sm:h-12 bg-emerald-100 dark:bg-emerald-900/30 rounded-xl flex items-center justify-center flex-shrink-0">
                        <svg class="block w-5 h-5 sm:w-6 sm:h-6 text-emerald-600 dark:text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-[20px] shadow-md border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
                <div class="flex items-start sm:items-center justify-between gap-3">
                    <div>
                        <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 break-words">Ongoing Job Orders</p>
                        <p class="text-xl sm:text-2xl font-bold text-blue-600 dark:text-blue-400 mt-1">{{ $stats['ongoing'] ?? 0 }}</p>
                    </div>
                    <div class="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 dark:bg-blue-900/30 rounded-xl flex items-center justify-center flex-shrink-0">
                        <svg class="block w-5 h-5 sm:w-6 sm:h-6 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-[20px] shadow-md border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
                <div class="flex items-start sm:items-center justify-between gap-3">
                    <div>
                        <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 break-words">Completed</p>
                    ...
                    <div class="w-10 h-10 sm:w-12 sm:h-12 bg-green-100 dark:bg-green-900/30 rounded-xl flex items-center justify-center flex-shrink-0">
                        <svg class="block w-5 h-5 sm:w-6 sm:h-6 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-3 sm:gap-4">
            <div class="xl:col-span-2 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-4 sm:p-5">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
                    <h3 class="text-base font-bold text-gray-900 dark:text-white break-words">Workflow Snapshot</h3>
                ...
                <div class="space-y-3">
                    <div>
                        <div class="flex items-center justify-between text-xs mb-1">
                            <span class="font-medium text-amber-700 dark:text-amber-300 break-words">New Requests</span>
                    ...
                    <div>
                        <div class="flex items-center justify-between text-xs mb-1">
                            <span class="font-medium text-emerald-700 dark:text-emerald-300 break-words">Approved</span>
                    ...
                    <div>
                        <div class="flex items-center justify-between text-xs mb-1">
                            <span class="font-medium text-blue-700 dark:text-blue-300 break-words">Ongoing</span>
                    ...
                    <div>
                        <div class="flex items-center justify-between text-xs mb-1">
                            <span class="font-medium text-green-700 dark:text-green-300 break-words">Completed</span>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-4 sm:p-5 space-y-3 sm:space-y-4">
                <h3 class="text-base font-bold text-gray-900 dark:text-white">Quick Actions</h3>

                <a href="{{ route('accounting.timeline') }}" class="flex items-center justify-between gap-3 p-3 rounded-xl border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/40 transition-colors">
                    <div>
                        <p class="text-sm font-semibold text-gray-900 dark:text-white break-words">Open Timeline</p>
                ...
                <div class="p-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/30">
                    <p class="text-sm font-semibold text-gray-900 dark:text-white break-words">Need Attention</p>
        ...
        <a href="{{ route('accounting.approvals') }}"
           class="group flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0 p-4 sm:p-5 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 hover:border-amber-400 dark:hover:border-amber-500 hover:shadow-md transition-all">
            <div class="flex items-center gap-3 sm:gap-4">
                <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center flex-shrink-0
                    ...
                    <svg class="block w-5 h-5 sm:w-6 sm:h-6 {{ $pendingApprovals->total() > 0 ? 'text-amber-600 dark:text-amber-400' : 'text-gray-400' }}"
                ...
                <div>
                    <p class="text-sm sm:text-base font-bold text-gray-900 dark:text-white break-words">Pending Approvals</p>
                    ...
                    @else
                        <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">No pending job orders — all clear!</p>
                    @endif
                </div>
            </div>
            <div class="flex items-center gap-2 sm:gap-3">
                ...
                @endif
                <svg class="w-5 h-5 text-gray-400 group-hover:text-amber-500 transition-colors flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
