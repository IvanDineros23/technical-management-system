...
@section('page-subtitle', 'Review and process job orders pending accounting approval')
...
<div class="space-y-6">
    ...
    <div class="flex flex-wrap items-center gap-4">
        <div class="flex items-center gap-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-2xl px-5 py-3">
            ...
            <div>
                <p class="text-xs text-amber-700 dark:text-amber-400 font-medium">Pending Approval</p>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
            <h2 class="text-base font-bold text-gray-900 dark:text-white">Job Orders for Approval</h2>
