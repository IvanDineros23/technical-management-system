...
@section('page-subtitle', 'Review and manage inventory requests from technicians')
...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-[20px] shadow-md border border-gray-200 dark:border-gray-700 p-6">
        <form method="GET" action="{{ route('tech-head.inventory.requests') }}" class="flex flex-wrap gap-4 items-end">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-sm space-x-2">
                            @if($inventoryRequest->status === 'pending')
                            <form method="POST" action="{{ route('tech-head.inventory.requests.update', $inventoryRequest) }}" style="display: inline;">
                                @csrf
                                @method('PATCH')
