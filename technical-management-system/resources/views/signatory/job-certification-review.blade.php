    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-200 dark:border-gray-700 p-6">
                <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-6">Job Order Details</h2>
                
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        <p class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Job Order Number</p>
                        <p class="text-xl font-bold text-gray-900 dark:text-white mt-1">{{ $jobOrder->job_order_number }}</p>
                    </div>
                    <div>
                        <p class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Customer</p>
                        <p class="text-lg font-semibold text-gray-900 dark:text-white mt-1">{{ $jobOrder->customer->name ?? 'N/A' }}</p>
                    </div>
                    <div>
                        <p class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Service Type</p>
                        <p class="text-gray-700 dark:text-gray-300 mt-1">{{ $jobOrder->service_type ?? 'N/A' }}</p>
                    </div>
                    <div>
            ...
            @if($report)
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-200 dark:border-gray-700 p-6">
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-6">Technician Report</h2>
                    
                    <div class="space-y-4">
                        <div>
                            <p class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Submitted By</p>
                            <p class="text-gray-700 dark:text-gray-300 mt-1">{{ optional($report->submittedBy)->name ?? 'N/A' }}</p>
                        </div>
                        <div>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-200 dark:border-gray-700 p-6 sticky top-6">
                <h2 class="text-lg font-bold text-gray-900 dark:text-white mb-6">Sign Certificate</h2>
                ...
                <form action="{{ route('signatory.job-certifications.sign', $jobOrder->id) }}" method="POST" class="space-y-4">
                    ...
                    <div class="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-lg p-4 mt-6">
                        <div class="flex items-start gap-3">
                            ...
                            <label for="confirm" class="text-sm text-emerald-700 dark:text-emerald-300">
                    ...
                    <div class="flex gap-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <a href="{{ route('signatory.job-certifications') }}" class="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            Cancel
                        </a>
