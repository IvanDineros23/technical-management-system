        ...
        <div class="space-y-4">
            ...
            @empty
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No job activities</h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Job order activities will appear here.</p>
                </div>
            @endforelse
        </div>
