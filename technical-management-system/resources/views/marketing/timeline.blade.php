    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <div class="bg-white dark:bg-gray-800 rounded-[20px] shadow-md border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
            <div class="flex items-center justify-between gap-3">
                <div>
                    <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Total Visible Jobs</p>
                    <p class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ $stats['total_jobs'] ?? 0 }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-[20px] shadow-md border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
            <div class="flex items-center justify-between gap-3">
                <div>
                    ...
                    <p class="text-xl sm:text-2xl font-bold text-yellow-600 dark:text-yellow-400 mt-1">{{ $stats['pending'] ?? 0 }}</p>
                </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-[20px] shadow-md border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
        <div class="flex items-center justify-between mb-4 sm:mb-6">
            <div class="bg-blue-600 text-white px-3 sm:px-4 py-2 rounded-lg">
                <h3 class="text-sm sm:text-base font-bold">Marketing Job Timeline</h3>
                <p class="text-xs sm:text-sm">Customer requests and job order activities</p>
            </div>
        </div>
