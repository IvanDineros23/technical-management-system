...
<?php $__env->startSection('page-subtitle', 'Manage system users and accounts'); ?>
...
<div class="space-y-6"
     x-data="{
        ...
        selectedUser: null,
        updateBaseUrl: '<?php echo e(url('/admin/users')); ?>',
        openEdit(user) {
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div class="bg-white dark:bg-gray-800 rounded-[20px] border border-gray-200 dark:border-gray-700 p-6">
            ...
            <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2"><?php echo e($stats['total']); ?></p>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-[20px] border border-gray-200 dark:border-gray-700 p-6">
            <p class="text-sm text-gray-600 dark:text-gray-400">Active</p>
            <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2"><?php echo e($stats['active']); ?></p>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-[20px] border border-gray-200 dark:border-gray-700 p-6">
            <p class="text-sm text-gray-600 dark:text-gray-400">Inactive</p>
            <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2"><?php echo e($stats['inactive']); ?></p>
        </div>
    </div>

    <!-- Filters -->
    <form class="bg-white dark:bg-gray-800 rounded-[20px] border border-gray-200 dark:border-gray-700 p-6" method="GET" action="<?php echo e(route('admin.users.index')); ?>">
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Search</label>
                <input type="text" name="search" value="<?php echo e($search); ?>" placeholder="Search by name or email..." class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            </div>
            <div>
                ...
                <select name="role" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ...
                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roleOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($roleOption->id); ?>" <?php echo e((string) $roleOption->id === (string) $role ? 'selected' : ''); ?>><?php echo e($roleOption->name); ?></option>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                            <td class="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white text-center"><?php echo e($user->name); ?></td>
                            <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400 text-center"><?php echo e($user->email); ?></td>
                            <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400 text-center"><?php echo e($user->role?->name ?? 'N/A'); ?></td>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400 text-center">
                                ...
                                ?>
                                <?php echo e($lastLoginFormatted); ?>

                            </td>
                            <td class="px-6 py-4 text-sm text-center space-x-3">
                                <button type="button"
                                        class="text-blue-600 hover:text-blue-900 dark:hover:text-blue-400"
                                        @click="openEdit(<?php echo \Illuminate\Support\Js::from([
                                            'id' => $user->id,
                                            'name' => $user->name,
                                            'email' => $user->email,
                                ...
                                <button type="button" 
                                        ...
                                        @click="openConfirmDeactivate(<?php echo \Illuminate\Support\Js::from(['id' => $user->id, 'name' => $user->name, 'email' => $user->email])->toHtml() ?>)">
                                    Deactivate
                                </button>
                                <button type="button"
                                        class="text-red-600 hover:text-red-900 dark:hover:text-red-400"
                                        @click="openConfirmDelete(<?php echo \Illuminate\Support\Js::from(['id' => $user->id, 'name' => $user->name, 'email' => $user->email])->toHtml() ?>)">
                                    Delete
                                </button>
                            </td>
                        </tr>
    ...
    <div x-show="showCreateUser" x-cloak class="fixed inset-0 z-50 overflow-y-auto" role="dialog" aria-modal="true">
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="showCreateUser"
                ...
                <form method="POST" action="<?php echo e(route('admin.users.store')); ?>" class="p-6 space-y-4">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="role_id" required class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roleOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($roleOption->id); ?>"><?php echo e($roleOption->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div>
                ...
                <form method="POST" :action="selectedUser ? `${updateBaseUrl}/${selectedUser.id}` : updateBaseUrl" class="p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4" x-show="selectedUser">
                        ...
                        <div>
                            ...
                            <select name="role_id" required class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roleOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($roleOption->id); ?>" :selected="selectedUser?.role_id == <?php echo e($roleOption->id); ?>"><?php echo e($roleOption->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\GitHub\technical-management-system\technical-management-system\resources\views/admin/users.blade.php ENDPATH**/ ?>