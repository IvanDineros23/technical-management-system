                ...
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            ...
                            <form action="<?php echo e(route('admin.settings.cache.clear')); ?>" method="POST" class="inline">
                                <?php echo csrf_field(); ?>
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            ...
                            <form action="<?php echo e(route('admin.settings.database.optimize')); ?>" method="POST" class="inline">
                                <?php echo csrf_field(); ?>
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            ...
                            <form action="<?php echo e(route('admin.settings.logs.clear')); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete old logs?')">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">Clear</button>
                            </form>
                        </div>
                ...
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            ...
                            <p class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo e(phpversion()); ?></p>
                        </div>
                        <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
