...
<?php $__env->startSection('page-subtitle', 'System activity and user action history'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <a href="<?php echo e(route('admin.audit-logs.export', request()->all())); ?>" class="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors flex items-center gap-2">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-[20px] border border-gray-200 dark:border-gray-700 p-6">
        <form id="auditLogFiltersForm" method="GET" action="<?php echo e(route('admin.audit-logs.index')); ?>" class="space-y-4">
            <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 items-end">
                ...
                <div class="lg:col-span-3">
                    ...
                    <select name="action" class="w-full h-12 px-4 border border-gray-300 dark:border-gray-600 rounded-2xl bg-gray-50 dark:bg-gray-700/80 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm">
                        ...
                        <option value="calibrate" <?php echo e(request('action') == 'calibrate' ? 'selected' : ''); ?>>Calibrate</option>
                    </select>
                </div>

                <div class="lg:col-span-3">
                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">Date Range</label>
                    <input type="date" name="date_from" value="<?php echo e(request('date_from')); ?>" class="w-full h-12 px-4 border border-gray-300 dark:border-gray-600 rounded-2xl bg-gray-50 dark:bg-gray-700/80 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm">
                </div>

                <div class="lg:col-span-3 flex items-center justify-end gap-2 whitespace-nowrap">
                    <a href="<?php echo e(route('admin.audit-logs.index')); ?>" class="h-12 inline-flex items-center justify-center px-5 bg-gray-200 text-gray-800 rounded-xl hover:bg-gray-300 transition-colors text-center font-medium">
                        Reset
                    </a>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                        <td class="px-6 py-4 text-center align-middle text-sm text-gray-600 dark:text-gray-400">
                            <?php echo e($log->created_at?->timezone('Asia/Manila')->format('M d, Y h:i A') ?? 'N/A'); ?>
                        ...
                        <td class="px-6 py-4 text-center align-middle">
                            ...
                            ?>
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium <?php echo e($classes); ?>">
                                <?php echo e(ucfirst(strtolower($log->action))); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\GitHub\technical-management-system\technical-management-system\resources\views/admin/audit-logs.blade.php ENDPATH**/ ?>